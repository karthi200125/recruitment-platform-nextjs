            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative z-10 flex max-w-5xl flex-col items-center text-center pt-32 lg:pt-40">
                    ...
                    >
                        <Link
                            href="/jobs"
                            className="group inline-flex h-14 items-center justify-center rounded-2xl bg-white px-8 text-sm font-semibold text-black transition-all duration-300 hover:scale-[1.02] hover:bg-white/90"
                        >
                            Find Jobs
                        ...
                        <Link
                            href="/post-job"
                            className="inline-flex h-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-8 text-sm font-medium text-white/80 backdrop-blur-xl transition-all duration-300 hover:border-white/20 hover:bg-white/[0.06] hover:text-white"
                        >
                            Hire Talent
                        </Link>
                    </motion.div>
                ...
                >
                    ...
                    <div className="relative overflow-hidden rounded-[24px] md:rounded-[32px]">
                        ...
                        {/* IMAGE */}
                        <Image
                            src="/hero-dashboard.png" // new transparent image
