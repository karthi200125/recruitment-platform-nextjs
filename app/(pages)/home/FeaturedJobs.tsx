...
const JobCard = ({ job, index }: { job: Job; index: number }) => {
    ...
    return (
        <article className="group flex flex-col rounded-2xl border bg-white/[0.04] p-6 hover:border-indigo-500/35 hover:-translate-y-1 hover:bg-zinc-900/80 hover:shadow-xl hover:shadow-indigo-500/[0.08] transition-all duration-300 cursor-pointer">
