...
import { getPlans, type Plan } from "@/lib/data/subscription-plans";
...
const PLANS: Record<Role, Plan[]> = getPlans();
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 mb-1">
                                    <p
                                        className={`text-sm font-semibold tracking-wide uppercase ${isFeatured ? "text-indigo-300" : "text-zinc-400"
                                            }`}
                                    >
                                        {plan.name}
                                    </p>
                                ...
                                <div className="flex items-end gap-1 mt-4 mb-6">
                                    ...
                                    <span
                                        className={`text-5xl font-bold tracking-tight leading-none ${isFeatured ? "text-white" : "text-zinc-100"
                                            }`}
                                    >
                                        {plan.price.toLocaleString("en-IN")}
                                    </span>

                                    <span className="text-sm text-zinc-500 mb-1 ml-0.5">
                                        /{plan.interval}
                                    </span>
                                </div>
                                ...
                                {/* Divider */}
                                <div
                                    className={`h-px mb-6 ${isFeatured
                                        ? "bg-indigo-500/20"
                                        : "bg-white/[0.06]"
                                        }`}
                                />
                                ...
                                <Link
                                    ...
                                    className={`w-full rounded-xl py-3 text-sm font-semibold transition-all duration-200 text-center ${isFeatured
